...
[Repository](https://github.com/masazelic/annrl-project) contains the code for implementing DQN and Dyna Agents in Mountain Car enviroment as well as reproducing the results from the report. All the implementations are using `torch` library. 
